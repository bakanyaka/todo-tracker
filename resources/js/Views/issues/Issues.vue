  ...
  <div class="animated fadeIn">
    ...
    <b-card>
      <template slot="header">
        ...
        <small class="pull-right">Синхронизация с Redmine выполнена {{
            meta.hasOwnProperty('last_sync') ?
        ...
        >
          ...
          <template v-slot:cell(actions)="data">
            <b-button-toolbar class="flex-nowrap">
              ...
              <b-button v-if="$user.is_admin" variant="danger" @click.stop="deleteIssue(data.item.id)" class="ml-1">
...
export default {
  ...
  methods: {
    ...
    async deleteIssue(id) {
      try {
        await axios.delete(route('api.issues.destroy', { issue: id }));
        this.$snotify.success('Задача удалена');
      } catch (e) {
        console.log(e);
        this.$snotify.error('Ошибка!');
      }
