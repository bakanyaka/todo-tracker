...
class RedmineServiceTest extends TestCase
{
    ...
    /** @test */
    public function it_fetches_issue_by_id_using_redmine_api()
    {
        ...
        $this->assertEquals([
            ...
            'category_id' => $issueData['category']['id'],
    ...
    /** @test */
    public function it_fetches_issue_category_by_id()
    {
        $response = [
            'issue_category' => [
                'id' => 1,
        ...
        $mock = new MockHandler([
            new Response(200, ['content-type' => 'application/json; charset=utf8'], json_encode($response)),
        ]);
        $handler = HandlerStack::create($mock);
        $client = new Client(['handler' => $handler]);

        $redmine = new RedmineApiService($client);
        $result = $redmine->getIssueCategory(1);

        $this->assertEquals($response['issue_category'], $result);
    }

    /** @test */
    public function it_fetches_all_issues_modified_since_given_date()
    {
        $mock = new MockHandler([
    ...
    /** @test */
    public function it_fetches_all_time_entries_since_given_date()
    {
        $mock = new MockHandler([
            new Response(200, ['content-type' => 'application/json; charset=utf8'],
    ...
    /** @test */
    public function it_fetches_all_projects()
    {
        $mock = new MockHandler([
            new Response(200, ['content-type' => 'application/json; charset=utf8'],
    ...
    /** @test */
    public function it_fetches_all_trackers()
    {
        $mock = new MockHandler([
            new Response(200, ['content-type' => 'application/json; charset=utf8'],
    ...
    /** @test */
    public function it_fetches_all_versions_for_specified_project()
    {
        $mock = new MockHandler([
            new Response(200, ['content-type' => 'application/json; charset=utf8'],
    ...
    protected function makeFakeRedmineIssue(array $attributes = []): array
    {
        $issue = [
            'issue' => array_merge([
